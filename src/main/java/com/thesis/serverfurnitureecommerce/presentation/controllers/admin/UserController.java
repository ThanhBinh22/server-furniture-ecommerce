...
public class UserController extends BaseController {
    ...
    @GetMapping("/get-user")
    public ResponseEntity<APIResponse<List<UserVO>>> getUser(HttpServletRequest httpServletRequest) {
        log.info("Get user");
    ...
    public ResponseEntity<APIResponse<List<UserVO>>> getAllUser(HttpServletRequest httpServletRequest) {
