...
public class VNPayController {
    ...
    public ResponseEntity<APIResponse<String>> getList(HttpServletRequest req) throws UnsupportedEncodingException {
        String username = UserUtil.getUsername();
        Double price = cartService.getCart(username).getAmount();
        ...
        vnp_Params.put("vnp_CreateDate", Instant.now().getEpochSecond()+"");
       ...
       return ResponseEntity.ok(new APIResponse<>(200, "success", paymentUrl));
    }
